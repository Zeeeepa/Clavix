...
✅ **No action required!** Clavix v3.0 is fully backward compatible.
...
- `clear-optimized-prompt*.md` → `optimized-prompt*.md`
...
**Changes:**
- `PromptOptimizer` → `UniversalOptimizer`
- `applyCLEARFramework()` → `optimize()`
...
**Migration Summary:**
- ✅ Upgrade: `npm install -g clavix@3.0.0`
- ✅ Update templates: `clavix update` (optional)
- ✅ Test: Run your usual workflow
- ✅ Done: Enjoy improved UX with same quality
